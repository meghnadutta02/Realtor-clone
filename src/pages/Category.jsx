    ...
    <div className="max-w-7xl w-[94%] mx-auto pt-4 mt-5 space-y-7 ">
      {offerListings && offerListings.length > 0 ? (
        <div className="flex flex-col items-center">
          <div className="text-3xl font-bold mb-5 ">Places for {type}</div>
        ...
        <p className="text-2xl mx-auto w-[25%] p-3 rounded-md border-2 border-green-300 text-center flex gap-3 items-center"><AiOutlineInfoCircle/>No listings</p>
      )}
    </div>
  );
};
